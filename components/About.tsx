...
import profilePic from "public/extraImages/gr.jpg";
    ...
    >
      ...
      <div className="px-0 md:px-8 lg:px-20 text-black dark:text-white">
        ...
        <div className="bg-blue-300/20 dark:bg-blue-300/10 py-[6px] md:ml-6 inline-flex items-center rounded-2xl gap-1 mt-2 text-blue-600">
          ...
          <p className="font-outfit mr-5 text-[12px] font-light link link-underline link-underline-black">
        ...
        <p className="text-sm md:text-base lg:text-lg font-light md:px-7 pt-3 font-outfit">
          ...
          <br /> I am a{" "}
          <span className="text-blue-500 font-semibold link link-underline link-underline-black">
            Software Developer
          </span>{" "}
          with a passion for building end-to-end products and developing
          scalable, high-impact projects. I love to create elegant solutions to
          complex problems.
          <br />
          <br />
          Graduated in{" "}
          <span className="text-blue-500 font-semibold link link-underline link-underline-black">
            <a>B.Tech Information Technology</a>
          </span>
          , from SRM University Chennai, looking for opportunities to work on
          challenging projects.
          <br /> <br /> Alongside my tech endeavors, I am an avid reader, enjoy
          listening to music, a movie buff and continually learning new skills
          while enjoying a{" "}
          <span className="text-blue-500 font-semibold link link-underline link-underline-black">
            fresh cup of coffee 🍵!
          </span>
